...
void drawLHCb(Bool_t withLogYaxis = kFALSE) {
	...
	const char* title1S =
	  ";#it{p}_{T}^{#varUpsilon(1S)} (GeV/#it{c});#chi_{b}-to-#varUpsilon(1S) feed-down fraction (in %)";

	auto* stat1Pto1S =
	  myStatGraph(title1S, nPoints1Pto1S_lhcb, ptBinning1Pto1S_lhcb, frac1Pto1S_lhcb8TeV, stat1Pto1S_lhcb8TeV, color1P, marker1P);

	auto* syst1Pto1S =
	  mySystGraph(nPoints1Pto1S_lhcb, ptBinning1Pto1S_lhcb, frac1Pto1S_lhcb8TeV, syst1Pto1S_lhcb8TeV, color1P);
	...
	auto* syst2Pto1S =
	  mySystGraph(nPoints2Pto1S_lhcb, ptBinning2Pto1S_lhcb, frac2Pto1S_lhcb8TeV, syst2Pto1S_lhcb8TeV, color2P);
	...
	auto* syst3Pto1S =
	  mySystGraph(nPoints3Pto1S_lhcb, ptBinning3Pto1S_lhcb, frac3Pto1S_lhcb8TeV, syst3Pto1S_lhcb8TeV, color3P);
	...
	const char* title2S =
	  ";#it{p}_{T}^{#varUpsilon(2S)} (GeV/#it{c});#chi_{b}-to-#varUpsilon(2S) feed-down fraction (in %)";

	auto* stat2Pto2S =
	  myStatGraph(title2S, nPoints2Pto2S_lhcb, ptBinning2Pto2S_lhcb, frac2Pto2S_lhcb8TeV, stat2Pto2S_lhcb8TeV, color2P, marker2P);

	auto* syst2Pto2S =
	  mySystGraph(nPoints2Pto2S_lhcb, ptBinning2Pto2S_lhcb, frac2Pto2S_lhcb8TeV, syst2Pto2S_lhcb8TeV, color2P);
	...
	auto* syst3Pto2S =
	  mySystGraph(nPoints3Pto2S_lhcb, ptBinning3Pto2S_lhcb, frac3Pto2S_lhcb8TeV, syst3Pto2S_lhcb8TeV, color3P);

	stat3Pto2S->Draw("PZ");
	syst3Pto2S->Draw("5");

	auto* legend2S = new TLegend(.2, .9, .4, .71, "LHCb 8 TeV data");
	...
	const char* title3S =
	  ";#it{p}_{T}^{#varUpsilon(3S)} (GeV/#it{c});#chi_{b}-to-#varUpsilon(3S) feed-down fraction (in %)";

	auto* stat3Pto3S =
	  myStatGraph(title3S, nPoints3Pto3S_lhcb, ptBinning3Pto3S_lhcb, frac3Pto3S_lhcb8TeV, stat3Pto3S_lhcb8TeV, color3P, marker3P);

	auto* syst3Pto3S =
	  mySystGraph(nPoints3Pto3S_lhcb, ptBinning3Pto3S_lhcb, frac3Pto3S_lhcb8TeV, syst3Pto3S_lhcb8TeV, color3P);

	stat3Pto3S->Draw("APZ");
	syst3Pto3S->Draw("5");

	auto* legend3S = new TLegend(.2, .9, .4, .77, "LHCb 8 TeV data");
