...
void feeddownsTo2S_AA(Bool_t withLegend = kTRUE, Bool_t withLogYaxis = kFALSE) {
	...
	const char* title = ";p_{T}^{#varUpsilon(2S)} (GeV);Fraction of #varUpsilon(2S) from feed-down (in %)";

	/// Chi_b first
	auto* stat2Pto2S = StatGraph(title, nPoints2Pto2S_lhcb, ptBinning2Pto2S_lhcb, frac2Pto2S_lhcb8TeV, stat2Pto2S_lhcb8TeV, color2P, marker2P);

	auto* syst2Pto2S = AsymmSystGraph(nPoints2Pto2S_lhcb, ptBinning2Pto2S_lhcb, xErrorWidth, frac2Pto2S_lhcb8TeV, downSyst2Pto2S_lhcb8TeV, upSyst2Pto2S_lhcb8TeV, color2P);
	...
	auto* stat3Pto2S = StatGraph(title, nPoints3Pto2S_lhcb, ptBinning3Pto2S_lhcb, frac3Pto2S_lhcb8TeV, stat3Pto2S_lhcb8TeV, color3P, marker2P);

	auto* syst3Pto2S = SystGraph(nPoints3Pto2S_lhcb, ptBinning3Pto2S_lhcb, xErrorWidth, frac3Pto2S_lhcb8TeV, syst3Pto2S_lhcb8TeV, color3P);
	...
	auto* stat3Sto2Sgraph_lhcb = StatGraph(title, nPoints_lhcb, ptBinning_2p0y4p5_lhcb7and8TeV, frac3Sto2S_lhcb, error3Sto2S_lhcb, color3Sto2S_, markerLHCb);
	...
	auto* stat3Sto2Sgraph_pbpb = StatGraph(title, nPoints_pbpb, ptBinning_pbpb, frac3Sto2S_pbpb, error3Sto2S_pbpb, colorCMS, markerCMS);
	...
	saveAs(canv, "feeddowns_to_2S_CMSPbPb");
}
