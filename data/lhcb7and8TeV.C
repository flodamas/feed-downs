// LHCb measurements at 7 and 8 TeV, from
// https://www.hepdata.net/record/ins1308738

/// Feed-down contributions to Y(1S) (in %)

// Chi_b(1P) -> Y(1S)
const Int_t nPoints1Pto1S_lhcb = 6;
Float_t pt1Pto1S_lhcb[] = {7, 9, 12, 16, 20, 31};
...
Float_t pt2Pto1S_lhcb[] = {7, 9, 12, 16, 20, 31};
...
Float_t pt3Pto1S_lhcb[] = {12, 16, 20, 31};
...
Float_t syst3Pto1S_lhcb8TeV[] = {0.1, 0.1, 0.1, 0.4};

/// Feed-down contributions to Y(2S) (in %)

// Chi_b(2P) -> Y(2S)
const Int_t nPoints2Pto2S_lhcb = 5;
Float_t pt2Pto2S_lhcb[] = {19, 21, 23, 26, 34};
...
Float_t syst2Pto2S_lhcb8TeV[] = {4, 3, 3, 6, 3};

// Chi_b(3P) -> Y(2S)
const Int_t nPoints3Pto2S_lhcb = 1;
Float_t pt3Pto2S_lhcb[] = {29};

Float_t frac3Pto2S_lhcb8TeV[] = {4.4};
Float_t stat3Pto2S_lhcb8TeV[] = {1.6};
Float_t syst3Pto2S_lhcb8TeV[] = {0.5};

/// Feed-down contributions to Y(3S) (in %)

// Chi_b(3P) -> Y(3S)
const Int_t nPoints3Pto3S_lhcb = 2;
Float_t pt3Pto3S_lhcb[] = {26.5, 34.5};

Float_t frac3Pto3S_lhcb7TeV[] = {44, 36};
Float_t stat3Pto3S_lhcb7TeV[] = {12, 14};
Float_t syst3Pto3S_lhcb7TeV[] = {10, 8.0};

Float_t frac3Pto3S_lhcb8TeV[] = {34, 40};
Float_t stat3Pto3S_lhcb8TeV[] = {8.0, 9.0};
Float_t syst3Pto3S_lhcb8TeV[] = {7.0, 9.5};
