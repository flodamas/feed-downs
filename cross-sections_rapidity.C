...
// Cross-sections as a function of rapidity, in nb

void cross_sections_rapidity() {
	...
	auto* statGraph1S_lhcb = myStatGraph(title, nPoints_lhcb, rapidityBinning_lhcb13TeV, cross1S_lhcb, error1S_lhcb, color1S, markerLHCb);

	// Y(2S)

	auto* statGraph2S_lhcb = myStatGraph(title, nPoints_lhcb, rapidityBinning_lhcb13TeV, cross2S_lhcb, error2S_lhcb, color2S, markerLHCb);

	// Y(3S)

	auto* statGraph3S_lhcb = myStatGraph(title, nPoints_lhcb, rapidityBinning_lhcb13TeV, cross3S_lhcb, error3S_lhcb, color3S, markerLHCb);
	...
	canvas->SaveAs("figures/cross-sections_rapidity_LHCb.png", "RECREATE");
	canvas->Close();
}
