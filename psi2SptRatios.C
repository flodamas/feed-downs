...
void psi2SptRatios(Bool_t withLogYaxis = kFALSE) {
	...
	auto* statGraph_cms7TeV = myStatGraph(title, nPtPoints_psi2S_cms7TeV, ptBinning_psi2S_cms7TeV, ptDiffRatio_psi2S_cms7TeV, statPtRatio_psi2S_cms7TeV, colorATLAS, markerATLAS);
	...
	statGraph_cms7TeV->GetXaxis()->SetLimits(0, 40);
	statGraph_cms7TeV->Draw("APZ");

	auto* systGraph_cms7TeV = mySystGraph(nPtPoints_psi2S_cms7TeV, ptBinning_psi2S_cms7TeV, xErrorWidth, ptDiffRatio_psi2S_cms7TeV, systPtRatio_psi2S_cms7TeV, colorATLAS - 1);
	...
	auto* statGraph_cms13TeV = myStatGraph(title, nPtPoints_psi2S_cms13TeV, ptBinning_psi2S_cms13TeV, ptDiffRatio_psi2S_cms13TeV, statPtRatio_psi2S_cms13TeV, colorCMS, markerCMS);

	statGraph_cms13TeV->Draw("PZ");

	auto* systGraph_cms13TeV = mySystGraph(nPtPoints_psi2S_cms13TeV, ptBinning_psi2S_cms13TeV, xErrorWidth, ptDiffRatio_psi2S_cms13TeV, systPtRatio_psi2S_cms13TeV, colorCMS - 1);
	...
	auto* statGraph_lhcb13TeV = myStatGraph(title, nPtPoints_psi2S_lhcb13TeV, ptBinning_psi2S_lhcb13TeV, ptDiffRatio_psi2S_lhcb13TeV, errorPtDiffRatio_psi2S_lhcb13TeV, colorLHCb, markerLHCb);
	...
	canv->SaveAs("figures/psi2StoJpsi.png", "RECREATE");
}
